...
public class OrientDBInfoDiscoverSpaceImpl implements InfoDiscoverSpace {
    ...
    public Fact addFact(Fact fact) throws InfoDiscoveryEngineRuntimeException {
        ...
        String factInstanceClassName=InfoDiscoverEngineConstant.CLASSINSTANCEPERFIX+orientDBClassName;
        try {
            ...
            String exceptionMessage="Init Fact data not match Fact Type "+factType+"'s validation requirement";
            throw InfoDiscoveryEngineException.getRuntimeException(exceptionMessage);
        }
        return null;
    }
    ...
    public Fact getFactById(String factId) throws InfoDiscoveryEngineRuntimeException {
        ...
        if(ov==null){
            ...
            String factType=ov.getType().getName();
            if(factType.startsWith(InfoDiscoverEngineConstant.CLASSPERFIX_FACT)){
                String factBusinessName=factType.replaceFirst(InfoDiscoverEngineConstant.CLASSPERFIX_FACT,"");
    ...
    public Dimension addDimension(Dimension dimension) throws InfoDiscoveryEngineRuntimeException{
        ...
        String dimensionInstanceClassName=InfoDiscoverEngineConstant.CLASSINSTANCEPERFIX+orientDBClassName;
        try{
            OrientVertex resultVertex = null;
            ...
            String exceptionMessage="Init Dimension data not match Dimension Type "+dimensionType+"'s validation requirement";
            throw InfoDiscoveryEngineException.getRuntimeException(exceptionMessage);
        }
        return null;
    }
    ...
    public Dimension getDimensionById(String dimensionId) throws InfoDiscoveryEngineRuntimeException{
        ...
        if(ov==null){
            ...
            String dimensionType=ov.getType().getName();
            if(dimensionType.startsWith(InfoDiscoverEngineConstant.CLASSPERFIX_DIMENSION)){
                String dimensionBusinessName=dimensionType.replaceFirst(InfoDiscoverEngineConstant.CLASSPERFIX_DIMENSION,"");
    ...
    public FactType addFactType(String factType) throws InfoDiscoveryEngineDataMartException {
        if(hasFactType(factType)){
            ...
            OrientVertexType rootFactType=this.graph.getVertexType(InfoDiscoverEngineConstant.FACT_ROOTCLASSNAME);
            if(rootFactType==null){
                this.graph.createVertexType(InfoDiscoverEngineConstant.FACT_ROOTCLASSNAME);
            }
            String orientDBClassName=InfoDiscoverEngineConstant.CLASSPERFIX_FACT+factType;
            OrientVertexType ovt=this.graph.createVertexType(orientDBClassName, InfoDiscoverEngineConstant.FACT_ROOTCLASSNAME);
            if(ovt!=null){
                FactType currentFactType=new OrientDBFactTypeImpl(ovt,this.graph);
                return currentFactType;
            }else{
    ...
    public List<String> getFactTypesList() {
        ...
        if(rootFactType==null){
            ...
            while(itr.hasNext()){
                ...
                String factType=className.replaceFirst(InfoDiscoverEngineConstant.CLASSPERFIX_FACT,"");
    ...
    public DimensionType addChildDimensionType(String childTypeName,String parentTypeName) throws InfoDiscoveryEngineDataMartException {
        String parentOrientDBClassName=InfoDiscoverEngineConstant.CLASSPERFIX_DIMENSION+parentTypeName;
        ...
        String childOrientDBClassName=InfoDiscoverEngineConstant.CLASSPERFIX_DIMENSION+childTypeName;
        ...
        OrientVertexType newOvt=this.graph.createVertexType(childOrientDBClassName, parentOrientDBClassName);
        if(newOvt!=null){
    ...
    public List<String> getRootDimensionTypesList() {
        ...
        OrientVertexType rootDimensionType=this.graph.getVertexType(InfoDiscoverEngineConstant.DIMENSION_ROOTCLASSNAME);
        if(rootDimensionType==null){
            ...
            while(itr.hasNext()){
                OClass currentClass= itr.next();
                String className=currentClass.getName();
                String dimensionType=className.replaceFirst(InfoDiscoverEngineConstant.CLASSPERFIX_DIMENSION,"");
    ...
    @Override
    public RelationType addRelationType(String relationType) throws InfoDiscoveryEngineDataMartException {
        if(hasRelationType(relationType)){
            ...
            OrientEdgeType rootRelationType=this.graph.getEdgeType(InfoDiscoverEngineConstant.RELATION_ROOTCLASSNAME);
            if(rootRelationType==null){
                this.graph.createEdgeType(InfoDiscoverEngineConstant.RELATION_ROOTCLASSNAME);
            }
            String orientDBClassName=InfoDiscoverEngineConstant.CLASSPERFIX_RELATION+relationType;
            OrientEdgeType oet=this.graph.createEdgeType(orientDBClassName, InfoDiscoverEngineConstant.RELATION_ROOTCLASSNAME);
            if(oet!=null){
    ...
    public RelationType addChildRelationType(String childTypeName, String parentTypeName) throws InfoDiscoveryEngineDataMartException {
        String parentOrientDBClassName=InfoDiscoverEngineConstant.CLASSPERFIX_RELATION+parentTypeName;
        ...
        String childOrientDBClassName=InfoDiscoverEngineConstant.CLASSPERFIX_RELATION+childTypeName;
        ...
        OrientEdgeType newOet=this.graph.createEdgeType(childOrientDBClassName, parentOrientDBClassName);
        if(newOet!=null){
    ...
    public List<String> getRootRelationTypesList() {
        ...
        if(rootRelationType==null){
            ...
            while(itr.hasNext()){
                OClass currentClass= itr.next();
                String className=currentClass.getName();
                String relationType=className.replaceFirst(InfoDiscoverEngineConstant.CLASSPERFIX_RELATION,"");
    ...
    public DimensionType addDimensionType(String typeName) throws InfoDiscoveryEngineDataMartException {
        if(hasDimensionType(typeName)){
            ...
            String orientDBClassName=InfoDiscoverEngineConstant.CLASSPERFIX_DIMENSION+typeName;
            OrientVertexType ovt=this.graph.createVertexType(orientDBClassName,InfoDiscoverEngineConstant.DIMENSION_ROOTCLASSNAME);
            if(ovt!=null){
                DimensionType newDimensionType=new OrientDBDimensionTypeImpl(ovt,this.graph);
                return newDimensionType;
            }else{
