...
public interface InfoDiscoverSpace {
    ...
    public Relation addDirectionalDimensionRelation(Dimension fromDimension,Dimension toDimension,String
            relationType,
                                                boolean repeatable)throws InfoDiscoveryEngineRuntimeException;
