package com.infoDiscover.app.base.time;

import com.infoDiscover.app.base.database.DatabaseManager;
import com.infoDiscover.app.base.time.dimension.YearDimension;
import com.infoDiscover.app.base.time.manager.TimeDimensionManager;
import com.infoDiscover.app.base.time.analytics.TimeAnalytics;
...
//        System.out.println("facts.count: " + facts.size());
        ...
        String sql = "select expand(in('ID_RELATION_created')) from id_dimension_m where y=2018 " +
                "and m=2 ";
        List<Relationable> facts = new TimeAnalytics().drillDownByYear(new YearDimension(2018), "created");
